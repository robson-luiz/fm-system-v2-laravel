...
@section('content')
    ...
    <div class="content-box">
        <div class="content-box-header">
            <h3 class="content-box-title">Cadastrar Objetivo</h3>
        ...
        <form action="{{ route('wishlist.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="form-input"
                    placeholder="Ex: Viagem para a Europa" value="{{ old('name') }}" required>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="target_amount" id="target_amount" class="form-input money-input"
                        placeholder="0,00" value="{{ old('target_amount') }}" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="current_amount" id="current_amount" class="form-input money-input"
                        placeholder="0,00" value="{{ old('current_amount', '0,00') }}">
                </div>
            </div>
                ...
                <div class="mb-4">
                    ...
                    <select name="priority" id="priority" class="form-input" required>
                        @foreach($priorities as $key => $value)
                            <option value="{{ $key }}" {{ old('priority', 'media') == $key ? 'selected' : '' }}>{{ $value }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="notes" id="notes" rows="3" class="form-input"
                    placeholder="Anotações adicionais...">{{ old('notes') }}</textarea>
            </div>
            ...
            <div class="flex justify-between">
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('wishlist.index') }}" class="btn-warning-md align-icon-btn">
