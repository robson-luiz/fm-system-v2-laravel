    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('edit-role')
                    <a href="{{ route('roles.edit', ['role' => $role->id]) }}" class="btn-warning-md align-icon-btn">
        ...
        <div class="detail-box">
            ...
            <div class="mb-1">
                <span class="title-detail-content">Ordem: </span>
                <span class="detail-content">{{ $role->order }}</span>
            </div>
