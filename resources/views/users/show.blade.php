    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('edit-user')
                    <a href="{{ route('users.edit', ['user' => $user->id]) }}" class="btn-warning-md align-icon-btn">
                ...
                @can('edit-image-user')
                    <a href="{{ route('users.edit_image', ['user' => $user->id]) }}" class="btn-warning-md align-icon-btn">
                        <!-- Ícone pencil-square (Heroicons) -->
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @can('edit-password-user')
                    <a href="{{ route('users.edit_password', ['user' => $user->id]) }}" class="btn-warning-md align-icon-btn">
                        <!-- Ícone pencil-square (Heroicons) -->
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="detail-box">
            ...
            @can('password-recovery-link-user')
                <div class="mb-1">
                    <span class="title-detail-content">Link Recuperar Senha: </span>
                    <span class="detail-content">
                        <a href="{{ route('users.password_recovery_link', ['user' => $user->id]) }}" class="link-primary">
